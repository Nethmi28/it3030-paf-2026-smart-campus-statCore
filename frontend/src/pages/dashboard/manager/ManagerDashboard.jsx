...
import { Building, CalendarCheck, Download, FileText, Loader2, Settings } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px' }}>
        ...
        <div style={surfaceStyle}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <button onClick={handleGenerateOperationsReport} style={quickActionStyle}>Generate Usage Report</button>
